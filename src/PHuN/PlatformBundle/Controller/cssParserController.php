...
class cssParserController extends Controller
{
    ...
    /**
     * Detect all elements inside the dtd and write new styles for these elements with div selectors. 
     * Function appends new css styles to original file.
     * Used by parseCssFileAction()
    ...
    */
    ...
    /**
     * Parses CSS. Function uses auxiliary functions splitFile() and detectElements()
     * @param integer $idCorpus
     * @param string $cssFile path to file containing css
     */

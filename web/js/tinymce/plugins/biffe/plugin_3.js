       ...
       onclick: function() {
           editor.windowManager.open({
              ...
              onsubmit: function(e) {
                  ...
                  editor.insertContent('<span class="biffe" title="'+ e.data.scripteur+'" data-scripteur="'+ e.data.scripteur+'" data-outil_ecriture="'+ e.data.outil_ecriture+'">' + e.data.title+ '</span>'+' ');
               }
           });
       }
   });
